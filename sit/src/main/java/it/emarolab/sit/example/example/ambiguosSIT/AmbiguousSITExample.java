package it.emarolab.sit.example.example.ambiguosSIT;
...
import it.emarolab.sit.example.example.simpleSpatialScenario.SimpleSITExample;
import it.emarolab.sit.example.example.simpleSpatialScenario.sceneElement.Cone;
import it.emarolab.sit.example.example.simpleSpatialScenario.sceneElement.GeometricPrimitive;
import it.emarolab.sit.example.example.simpleSpatialScenario.sceneElement.Plane;
import it.emarolab.sit.example.example.simpleSpatialScenario.sceneElement.Sphere;
import it.emarolab.sit.example.example.simpleSpatialScenario.sceneRelation.SpatialEvaluator;
import it.emarolab.sit.example.example.simpleSpatialScenario.sceneRelation.SpatialRelation;
