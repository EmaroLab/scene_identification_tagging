 ...
 */
public interface Xdef<I extends Ground<?,?>, S, A extends Semantic.AtomBase<?>>
            extends Axiom <I,S,A>{ // aXiom Representation

    interface Data<I extends Ground<?,?>, S, A extends Adef.Literal<S,?>>
            extends Axiom<I,S,A>, Xdef<I,S,A>{
    }
    ...
    interface Types<I extends Ground<?,?>, A extends Adef.Classes<? extends Collection<? extends Adef.Class<?>>,?>>
            extends Axiom<I,Void,A>, Xdef<I,Void,A>{
    }
