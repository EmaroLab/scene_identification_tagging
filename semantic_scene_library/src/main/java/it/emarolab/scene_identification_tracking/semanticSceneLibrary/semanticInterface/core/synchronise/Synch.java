...
/*
    abstract class SetSynchroniser< I extends OWLObject, A extends Adef<?>, T extends OWLObject>
        ...
        public SetSynchroniser(Mapping.Intent<I,A,Mapping.ReadingState> intent) {
            super(intent);
        }
    ...
    abstract class SetWriter< I extends OWLObject, A extends Adef<?>, T extends OWLObject>
            extends Synchroniser<I,A,Mapping.WritingState> {
